...
<a class="navbar-brand" href="..\index.php" class="navbar-brand" id="adolfo"><img src="../recursos\img\admin.svg" alt="Administrador" style="height:40px;"></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item h4">
            <a class="nav-link text-secondary" href="login.php">Home</a>
        </li>
        <li class="nav-item dropdown h4">
            <a class="nav-link text-secondary" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Proyectos</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <!-- <a class="dropdown-item" target="_blank" href="proyectos/age/index.php">Agencia Telde</a> -->
                <!-- <a class="dropdown-item" target="_blank" href="proyectos/veranojoven/index.htm">Verano joven 2016</a> -->
            </div>
        </li>
        <li class="nav-item dropdown h4">
            <a class="nav-link text-secondary" id="mp_cursos" href="#"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Cursos</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="../vista/cursos.php?pg=jquery">JQuery</a>
        ...
        <li class="nav-item dropdown h4">
            <a class="nav-link text-secondary" href="#" id="mp_certificados" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Certificados</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <li class="nav-item dropdown h4">
            <a class="nav-link text-secondary" href="#" id="mp_hobbies" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Hobbies</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <li class="nav-item dropdown h4">
            <a class="nav-link text-secondary" href="#" id="mp_galerias" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Galerías</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
