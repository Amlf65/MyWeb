...
<body vlink="#1E4873" alink="#1E4873" link="#1E4873" bgcolor="#edf7de" text="#1E4873">
        ...
        <TABLE align="center" WIDTH="90%" BORDER="1" CELLSPACING="2" CELLPADDING="2" bordercolor="#093409">
            ...
            <tr>
                ...
                <td align='center' valign='middle' col width="7%">
                    <font face='Arial' size=2><b><?php echo $datos[0] ?></b></font>
                </td>
                <td align='left' valign='middle' col width="19%">
                    <a href="tramos.php?tr=<?php echo $datos[0]?>" target="_top">
                        <font face="Arial" size=2><b><?php echo $datos[1] ?></b></font>
                    </a></td>
                <td align='right' valign='middle' col width="10%">
                    <font face='Arial' size=2><b><?php echo $datos[2] ?> Kms </b></font>
                </td>
                <td align='right' valign='middle' col width="10%">
                    <font face='Arial' size=2><b><?php echo $datos[3] ?> Km/h </b></font>
                </td>
                <td align='right' valign='middle' col width="7%">
                    <?php if("$datos[4]"<>''){
                    echo "<font face='Arial' size=2><b>$datos[4]</b></font>";
                    }	
                    else
                    {
                    echo "<font face='Arial' size=3><b> .. </b></font>";
                    }
                    ?>
                </td>
                <td align='right' valign='middle' col width="7%">
                    <?php if("$datos[5]"<>''){
                    echo "<font face='Arial' size=2><b>$datos[5]</b></font>";
                    }	
                    else
                    {
                    echo "<font face='Arial' size=3><b> .. </b></font>";
                ...
                <td align='right' valign='middle' col width="7%">
                    <?php if("$datos[6]"<>''){
                    echo "<font face='Arial' size=2><b>$datos[6]</b></font>";
                    }	
                    else
                    {
                    echo "<font face='Arial' size=3><b> .. </b></font>";
                ...
                <?php if ($datos[0]==1) {	
                    ...
                    echo"<font face='Arial' size=2><b>Penalizaciones</font><b><br>";
                        if(file_exists('penalizaciones.pdf')) {echo "<a href='penalizaciones.pdf' TARGET='_new'><img src='pdf.gif' border='0' align='center'></a>";}	
                        echo " ";
                        if(file_exists('penalizaciones.xls')) {echo "<a href='penalizaciones.xls' TARGET='_new'><img src='excel.gif' border='0' align='center'></a>";}
                    echo "<br><br><br>";
                    echo"<font face='Arial' size=2><b>Retirados</font><b><br>";		
                        if(file_exists('retirados.pdf')) {echo "<a href='retirados.pdf' TARGET='_new'><img src='pdf.gif' border='0' align='center'></a>";}		
                        echo " ";
                        if(file_exists('retirados.xls')) {echo "<a href='retirados.xls' TARGET='_new'><img src='excel.gif' border='0' align='center'></a>";}
                    echo "<br><br><br>";
