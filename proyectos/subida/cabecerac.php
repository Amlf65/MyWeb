...
<TABLE WIDTH="90%" align="center" BORDER="0" CELLSPACING="0" CELLPADDING="2" bordercolor="#edf7de"> 
	...
	<b><font color="#050000" face="Arial" size=5> <div style="text-align: center font-size=10"><?php echo $lines[0] ?></div> <div style="text-align: center"><?php echo $lines[1] ?></div></font></b> </td>
...
<TABLE WIDTH="90%" align="center" BORDER="1" CELLSPACING="0" CELLPADDING="2" bordercolor="#edf7de"> 
	<td  style="background-color: rgb(9, 52, 9);color="#FFFFFF"; align="right";">""</td>
</TABLE>
...
<td align='left' valign='middle' col width="40%"><font face="Arial" size=2><b>Tramo cronometrado</b></font></td>
